...
function openApp(appParams, options) {
  ...
  if (!Utils.isMobileMobile() && options.mobile.showInstallTip) {
...
function showNanoInstallTip(options) {
  ...
  installBtn.onclick = function () {
    ...
    background = null;
    //window.location.href = "https://nano.dfd.io/";
    window.open("https://nano.dfd.io/");
  };
}
...
var openExtension = function (params) {
    ...
    window.postMessage({
        "src": "dfdPay",
        "logo": "dfd", //to distinguish from other messages
        "params": params
    }, "*");
};
...
window.addEventListener('message', function (resp) {
    ...
    //console.log("dfdpay: received resp.data: " + JSON.stringify(resp.data));
...
},{"./Utils":1,"./appHandler":2,"./config":3,"./extensionHandler":4,"./mobileHandler":6,"./qrcode":8,"bignumber.js":9}],8:[function(require,module,exports){
"use strict";
...
},{}],"dfdpay":[function(require,module,exports){
"use strict";
...
},{"./libs/Utils":1,"./libs/config":3,"./libs/http":5,"./libs/pay":7,"bignumber.js":9,"extend":12}]},{},[]);
