...
export default {
    // decode from dfd pc wallet wallet.json
    decodeWalletJson(walletJson, password) {
        const walletInfo = new DfdAccountsWalletInfo(walletJson);
