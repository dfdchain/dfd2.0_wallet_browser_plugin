...
ChainConfig.networks["DFDTEST"] = {
    core_asset: "DFD",
    address_prefix: "DFDT",
    chain_id: "68a46fbb5048e5bc0586d38f560e50014f9f34f23679a3fb6ceba63255ba1b1b" // TODO: invalid testnet chainId
};

ChainConfig.networks["DFD"] = {
    core_asset: "DFD",
    address_prefix: "DFD",
    chain_id: "ea1ecf2d8a22d5894280aca2327423f42226e0ecf656f4869972c1c83b6f2a63"
};
...
class TransactionBuilder {
    ...
    */
    ...
    getBufferFromBytes(bytes) {
        return ops.rawTypes.bytes().fromObject(bytes);
    }
    ...
    */
    ...
    recoverPublicKeyFromBufferFunc(sig, buffer) {
        return Signature.fromBuffer(sig).recoverPublicKeyFromBuffer(buffer);
    }
    ...
    // TODO: wrap transfer, contract register(from gpc, from bytecode), contract invoke op create helper, invoke_contract_testing, register_contract_testing
...
function _broadcast(was_broadcast_callback) {
    return new Promise((resolve, reject) => {
        ...
        Apis.instance()
            .network_api()
            .exec("broadcast_transaction_synchronous", [tr_object])
