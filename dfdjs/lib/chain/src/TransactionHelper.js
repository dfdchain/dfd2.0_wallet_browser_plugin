...
helper.getEmptyAddress = function() {
    return "D596YFweJQuHY1BbjazZYmAbt8jJPbKehC";
    // if (ChainConfig.address_prefix === "DFDT") {
    //     return "D8xB9XuiWygAuMbYBziYRx6ZEddm3Mbas1";
    // }
    // return "D8xB9XuiWygAuMbYBziYRx6ZEddm3Mbas1";
};
...
helper.new_transfer_operation = function(
    ...
    if (memo) {
        ...
        memoObject = {
            from: "D1111111111111111111111111111111114T1Anm",
            to: "D1111111111111111111111111111111114T1Anm",
            nonce: 0,
            message: memo
        };
    }
