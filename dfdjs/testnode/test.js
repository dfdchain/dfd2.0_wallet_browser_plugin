...
ChainConfig.setChainId(
    ...
    "68a46fbb5048e5bc0586d38f560e50014f9f34f23679a3fb6ceba63255ba1b1b" // testnet
    // "ea1ecf2d8a22d5894280aca2327423f42226e0ecf656f4869972c1c83b6f2a63" // mainnet
);

let nodeApiUrl = "wss://node.dfdtw.com/";

ChainConfig.address_prefix = "DFD";
...
let emptyPubKey = PublicKey.fromStringOrThrow('D1111111111111111111111111111111114T1Anm')
let emptyAddr = emptyPubKey.toAddressString(ChainConfig.address_prefix,
    Address.AddressVersion.NORMAL)
console.log('emptyAddr: ' + emptyAddr)

var rawSig = TransactionHelper.signHex("112233", pkey, pubkey);
console.log("rawSig", rawSig.toHex());

let toAddress = "DNLhDsXUTy87nGYHfUsCD797MyDCUgXEAgr";
...
function testInvokeContract(tr) {
    var contractId = "DFDCeMwCyGJhQhpXPZoMPYKgWuuh7eEzgCwkS";
    var contractApi = "balanceOf";
    var apiArg = "DFDNUE3EyLeWpN5XA8S4q5DVrbGguWSmPfSoN";
...
function testTransferToContract(tr) {
    let contractId = "DFDCeMwCyGJhQhpXPZoMPYKgWuuh7eEzgCwkS";
    let assetId = "1.3.0";
    let assetAmount = 1;
    let memo = "test";
...
function testLockBalanceToMiner(tr) {
...
function testForecloseBalanceFromMiner(tr) {
    let assetId = "1.3.0";
...
function testTakePaybackFromMiner(tr) {
...
// testLockBalanceToMiner(tr);
// testForecloseBalanceFromMiner(tr);
// testTakePaybackFromMiner(tr);
...
let pubkeystr = "DFDN8mT7XvtTARjdZQ9bqHRoJRMf7P7azFqTQACckaVenM2GmJyxLh ";
...
nodeClient
    ...
    .then(function() {
        ...
        nodeClient
            .getAccountByAddresss("DFDNdkruwzhKc8EQKVNirF7xPLLpEojResJcZ")
            .then(r => {
