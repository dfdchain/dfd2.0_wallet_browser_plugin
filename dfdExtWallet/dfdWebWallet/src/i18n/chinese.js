export default {
    toolbar: {
        ...
        contract_invoke: '调用合约',
        contract_transfer: '转账到合约'
    },
    myWalletPage: {
        my_address: '我的地址',
        account_name: '账户名称',
    ...
    transferPage: {
        ...
        you_can_query_tx_status_on_chain: '你可以在DFD区块链上查询到这笔交易的状态和结果了',
    ...
    registerAccount: {
        ...
        fee: '手续费',
        register_now: '立即注册',
        register_request_sent_please_refresh_later: '注册请求已发出，请等5秒后刷新界面',
