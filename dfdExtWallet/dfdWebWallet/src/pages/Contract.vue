<template>
  <div>
    <div class="dfd-main-container dfd-contract-container">
      <div class="-nav-side">
        <!-- <SideNavbar
          :items="navbarItems"
        ...
        ></SideNavbar> -->
        <el-radio-group
          v-model="selectedNavbarItem"
          size="mini"
          @change="onSelectNavbarItem"
        >
          <el-radio-button
...
export default {
  ...
  methods: {
    ...
    onSelectNavbarItem(item) {
      ...
      this.selectedNavbarItem = item.key || item;
    },
    onSelectKeystoreFile(keyJson, filename) {
      console.log(keyJson, filename);
      // TODO
    },
    ...
    doTransfer() {
      ...
      appState
        ...
        .then((tr) => {
          ...
          tr.sign();
          let txid = tr.sha256(tr.tr_buffer).toString("hex").substr(0, 40);
...
.dfd-contract-inner-container,
.dfd-contract-done-inner-container {
  width: 400pt;
