<template>
  <div>
    <div v-if="!registerDone" class="dfd-main-container dfd-register-account-container">
      ...
      <el-form
        ...
        label-width="100pt"
        class="dfd-register-account-inner-container"
      >
        <el-form-item
        ...
        <el-form-item v-bind:label="$t('registerAccount.fee')" class="-fee-panel" prop="feeAmount">
          <div style="text-align: left; padding-left: 50pt;">10 DFD</div>
        </el-form-item>
        <el-form-item>
          <el-button
            type="primary"
    ...
    <div v-if="registerDone" class="dfd-main-container dfd-register-account-done-container">
      <div
...
<style lang="less">
.dfd-register-account-container1 {
  .label-font {
    color: #a99eb4;
    font-size: 8pt;
  }
}
.dfd-register-account-container2 {
  .label-font {
    color: #a99eb4;
    font-size: 8pt;
  }
}
.dfd-register-account-container,
.dfd-register-account-done-container {
  min-width: 400px;
  min-height: 266pt;
...
.dfd-register-account-inner-container {
  width: 400pt;
