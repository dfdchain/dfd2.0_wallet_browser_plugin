<template>
  <div>
    <div class="dfd-main-container dfd-customize-network-container">
      <div class="-customize-network-title">{{$t('customizeNetworkPage.title')}}</div>
      <div v-if="!customizeNetworkDone">
        <el-form
          ...
          label-width="90pt"
          class="dfd-customize-network-inner-container"
        >
      ...
      <div v-if="customizeNetworkDone" class="dfd-customize-network-done-container">
  ...
  data() {
    return {
      customizeNetworkForm: {
        chainId: 'e7d71ca6f5140b3bcb91b44a992eebd55594fe0e980366d60b688c32f53539d3'
      },
...
<style lang="less">
.dfd-customize-network-container1 {
  .label-font {
    color: #a99eb4;
    font-size: 8pt;
  }
}
.dfd-customize-network-container2 {
  .label-font {
    color: #a99eb4;
    font-size: 8pt;
  }
}
.dfd-customize-network-container,
.dfd-customize-network-done-container {
  min-width: 400px;
  min-height: 266pt;
