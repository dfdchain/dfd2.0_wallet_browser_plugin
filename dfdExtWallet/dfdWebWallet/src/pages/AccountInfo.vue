<template>
  <div>
    <div>
      <div class="dfd-panel dfd-account-info-panel">
        <el-row class="-address-row">
          ...
          <el-col :span="4">
            <div class="grid-content label-font" v-if="false">{{$t('accountInfoPage.account_name')}}</div>
          </el-col>
          <el-col :span="8">
...
export default {
  ...
  data() {
    return {
      ...
      infoAccountBalances: [utils.emptyDfdBalance],
