<template>
  <div>
    <div class="dfd-panel dfd-transfer-contract-container">
      <div class="-left-side" v-if="step==='transfer'">
        <el-form
          ...
          ref="contractForm"
          label-width="90pt"
          class="dfd-transfer-contract-inner-container"
        >
        ...
        >
          <div>
            ...
            <el-row style="margin-bottom: 15pt;">
              ...
              <el-col :span="16">
                <div class="grid-content label-font value-label">0.001DFD</div>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="8">
      ...
      currentAccountBalances: [
        {
          ...
          assetSymbol: "DFD",
          amount: 0,
          precision: appState.dfdPrecision,
...
<style lang="less">
.dfd-transfer-contract-container {
  min-width: 400px;
  min-height: 381pt;
  background: inherit;
...
.chrome-ext-app-container .dfd-transfer-contract-container {
  .-input-gas-price.asset-input-wrapper {
    .el-input {
...
.dfd-transfer-contract-inner-container,
.dfd-transfer-contract-done-inner-container {
  min-width: 360pt;
