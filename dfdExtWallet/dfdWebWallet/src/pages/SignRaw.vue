<template>
  <div>
    <div class="dfd-main-container dfd-sign-raw-container">
      ...
      <div v-if="!signRawDone">
        <el-form
          ...
          ref="signRawForm"
          label-width="90pt"
          class="dfd-sign-raw-inner-container"
        >
          <div>
            <el-input
              class="-input-address"
      ...
      <div v-if="signRawDone" class="dfd-sign-raw-done-container">
...
<style lang="less">
.dfd-sign-raw-container1 {
  .label-font {
    color: #a99eb4;
    font-size: 8pt;
  }
}
.dfd-sign-raw-container2 {
  .label-font {
    color: #a99eb4;
    font-size: 8pt;
  }
}
.dfd-sign-raw-container,
.dfd-sign-raw-done-container {
  min-width: 400px;
  min-height: 266pt;
  .-sign-raw-title {
    font-size: 20pt;
